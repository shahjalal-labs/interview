...
| 📝 **Detail**           | 📌 **Value**                                                              |
|------------------------|---------------------------------------------------------------------------|
| 🔗 **GitHub URL**       | [https://github.com/shahjalal-labs/interview](https://github.com/shahjalal-labs/interview)                                                                  |
...
| 📁 **Directory**        | `/run/media/sj/developer/web/L1B11/career/interview`                                                                      |
| 📅 **Created On**       | `15/08/2025 06:08 অপরাহ্ণ শুক্র GMT+6`                                                                      |
